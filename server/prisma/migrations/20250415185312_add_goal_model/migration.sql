-- CreateEnum
CREATE TYPE "EmailType" AS ENUM ('BUDGET_ALERT', 'MONTHLY_REPORT');
...
-- CreateEnum
CREATE TYPE "TransactionCategory" AS ENUM ('SALARY', 'INVESTMENTS', 'FOOD', 'TRANSPORT', 'HOUSING', 'ENTERTAINMENT', 'TRAVEL', 'HEALTH', 'SHOPPING', 'MISCELLANEOUS');
...
-- AddForeignKey
ALTER TABLE "scheduled_emails" ADD CONSTRAINT "scheduled_emails_accountId_fkey" FOREIGN KEY ("accountId") REFERENCES "accounts"("id") ON DELETE CASCADE ON UPDATE CASCADE;
